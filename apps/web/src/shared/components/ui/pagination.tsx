...
function PaginationPrevious({ className, text, ...props }: ComponentProps<typeof PaginationLink> & { text?: string }) {
  const { t } = useAppContext()
...
function PaginationNext({ className, text, ...props }: ComponentProps<typeof PaginationLink> & { text?: string }) {
  const { t } = useAppContext()
