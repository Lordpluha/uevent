  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/50 flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-muted-foreground mb-6">{t.paymentFailed.description}</p>
        ...
        <div className="mb-8 p-4 bg-card rounded-lg border border-border">
          ...
          <p className="text-xs text-muted-foreground">{t.paymentFailed.keepRecords}</p>
        </div>
        ...
        <div className="mt-6 p-4 bg-muted rounded-lg">
          <p className="text-xs text-muted-foreground">{t.paymentFailed.helpText}</p>
        </div>
      </div>
    </div>
  )
